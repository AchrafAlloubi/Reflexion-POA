...
public class VoitureFactoryMeta {
    public static Voiture buildVoitureMeta(String nomClasse, boolean sport, int vitesse) {
        if (sport)
            nomClasse += "Sport";
        ...
        StringSource sourceMeta = VoitureFactoryMeta.buildMeta(nomClasse, sport);
    ...
    private static StringSource buildMeta(String nomClasse, boolean sport) {
        ...
        genererAttributsMeta(sb, sport);
        genererConstructeursMeta(nomClasse, sport, sb);
        genererMethodesMeta(sb);
        sb.append("}\n");
    ...
    private static void genererConstructeursMeta(String nomClasse, boolean sport, StringBuilder sb) {
        if (sport)
    ...
    private static void genererMethodesMeta(StringBuilder sb) {
        sb.append("@Override\npublic int surveiller(int limite) { return getVitesse() - limite; }\n");
    }

    private static void genererAttributsMeta(StringBuilder sb, boolean sport) {
